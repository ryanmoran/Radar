  ...
  override func spec() {
    ...
    beforeEach {
      ...
      group = GroupFactory.newGroup(name: "some-group", jobs: [
        JobFactory.newJob(id: 1, name: "some-job", paused: false, finishedBuild: nil, nextBuild: nil, pipeline: pipeline),
        JobFactory.newJob(id: 1, name: "other-job", paused: false, finishedBuild: nil, nextBuild: nil, pipeline: pipeline)
        ], pipeline: pipeline)
    }
    ...
    it("has a status/transientStatus") {
      ...
      var jobs = [
        JobFactory.newJob(id: 1, name: "first-job", paused: false, finishedBuild: succeededBuild, nextBuild: nil, pipeline: pipeline),
        JobFactory.newJob(id: 2, name: "second-job", paused: false, finishedBuild: abortedBuild, nextBuild: nil, pipeline: pipeline),
        JobFactory.newJob(id: 3, name: "third-job", paused: false, finishedBuild: erroredBuild, nextBuild: pendingBuild, pipeline: pipeline),
        JobFactory.newJob(id: 4, name: "fourth-job", paused: false, finishedBuild: pendingBuild, nextBuild: nil, pipeline: pipeline),
        JobFactory.newJob(id: 5, name: "fifth-job", paused: false, finishedBuild: failedBuild, nextBuild: startedBuild, pipeline: pipeline),
        JobFactory.newJob(id: 6, name: "sixth-job", paused: false, finishedBuild: startedBuild, nextBuild: nil, pipeline: pipeline),
        JobFactory.newJob(id: 7, name: "seventh-job", paused: true, finishedBuild: nil, nextBuild: nil, pipeline: pipeline),
      ]
    ...
    describe("Equatable") {
      it("can be equated") {
        let job1 = JobFactory.newJob(id: 1, name: "some-job", paused: false, finishedBuild: nil, nextBuild: nil, pipeline: pipeline)
        let job2 = JobFactory.newJob(id: 1, name: "other-job", paused: false, finishedBuild: nil, nextBuild: nil, pipeline: pipeline)
